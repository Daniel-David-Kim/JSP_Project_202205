			...
			<article class="article_main">
				...
				<form class="form_template">
					...
					<div class="form_container" style="justify-content:left;">
						<h2 class="form_label">Please enter your name</h2>
					</div>
					...
					<p class="depth_p"></p>
					<div class="form_container" style="justify-content:left;">
						<h2 class="form_label">Please enter your contact</h2>
					</div>
					<p class="depth_p slim"></p>
					<div class="form_container">
					...
					<div class="form_container arrange">
						<a href="./findpw.jsp" class="form_link">Find Password</a>
						<a href="./signup.jsp" class="form_link">Create a new account</a>
					</div>
					<p class="depth_p"></p>
				</form>
