...
insert into C_TBL (scat_num, title, content, vid_title, vid_url, code, summary, img) values(1, '소개', '"너무 좋습니다 ! 책으로 먼저 배열과 포인터를 공부했는데 이해가 되지 않아서 이 강의 영상을 보니 단번에 이해가 되었어요!"
...
insert into C_TBL (scat_num, title, content, vid_title, vid_url, code, summary, img) values(2, '환경설정', '', '강의', 'https://www.youtube.com/embed/_jjZysGQS_w', null, null, null);
